...
class CLogger
{
	public:
		...
		static nau_API void AddLog (LogLevel level, std::string file = "");
		static nau_API void Log (LogLevel logLevel, std::string sourceFile, int line, std::string message);
		static nau_API void LogSimple (LogLevel logLevel, std::string message);
		static nau_API void LogSimpleNR (LogLevel logLevel, std::string message);
		static nau_API bool HasLog(LogLevel logLevel);
		static nau_API void CloseLog(LogLevel level);
