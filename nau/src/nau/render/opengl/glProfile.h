...
#define PROFILE(name) nau::render::Profile __profile(name)
#define PROFILE_GL(name) nau::render::Profile __profile(name, false)
#elif NAU_PROFILE == NAU_PROFILE_CPU_AND_GPU
#define PROFILE(name) nau::render::Profile __profile(name)
#define PROFILE_GL(name) nau::render::Profile __profile(name, true)
#endif
#endif
