...
Light::Init() {
	...
	Attribs.add(Attribute(COLOR, "COLOR", Enums::DataType::VEC4, false, new vec4(1.0f, 1.0f, 1.0f, 1.0f), new vec4(), new vec4(1.0f), IAPISupport::APIFeatureSupport::OK, Attribute::COLOR));
	Attribs.add(Attribute(AMBIENT, "AMBIENT", Enums::DataType::VEC4, false, new vec4(0.2f, 0.2f, 0.2f, 1.0f), new vec4(), new vec4(1.0f), IAPISupport::APIFeatureSupport::OK, Attribute::COLOR));
	// FLOAT
