...
*/
		...
		public:
			...
			std::shared_ptr<nau::scene::Camera> &getCamera (const std::string &cameraName);
			...
			std::shared_ptr<nau::scene::Camera> &getCurrentCamera();
			...
			std::shared_ptr<nau::scene::Light> &getLight (const std::string &lightName);
			//! Returns the named light. If it does not exist, it creates a light of the given class
			std::shared_ptr<nau::scene::Light> &createLight (const std::string &lightName, const std::string &lightClass);
			...
			std::shared_ptr<nau::scene::IScene> & createScene (const std::string &sceneName, const std::string &sceneType = "OctreeUnified");
			//! Return the named scene. If it does not exist it creates one
			std::shared_ptr<nau::scene::IScene> & getScene (const std::string &sceneName);
