...
namespace nau {
	...
	public:
		...
		virtual NauIntArray getPropiv(IntArrayProperty prop);
		virtual bool isValidiv(IntArrayProperty prop, NauIntArray &value);
		virtual void setPropiv(IntArrayProperty prop, NauIntArray &value);
