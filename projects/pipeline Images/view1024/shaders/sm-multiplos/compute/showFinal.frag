...
layout(binding=1, offset=480) uniform atomic_uint atPVPL;		
layout(binding=1, offset=484) uniform atomic_uint atPVCL;		   	
layout(binding=1, offset=488) uniform atomic_uint atLight;		
layout(binding=1, offset=492) uniform atomic_uint atShadow;
layout(binding=1, offset=496) uniform atomic_uint atDoubtLight;		
layout(binding=1, offset=500) uniform atomic_uint atDoubtShadow;
layout(binding=1, offset=504) uniform atomic_uint atCorrectL;		
layout(binding=1, offset=508) uniform atomic_uint atIncorrectL;   	
layout(binding=1, offset=512) uniform atomic_uint atCorrectS;   	
layout(binding=1, offset=516) uniform atomic_uint atIncorrectS;   	
layout(binding=1, offset=520) uniform atomic_uint atTotal;  	
