...
layout(binding=1, offset=440) uniform atomic_uint at0;		//Light Pixels no SM Encolhido
layout(binding=1, offset=444) uniform atomic_uint at1;		//Shadow Pixels no SM Encolhido
layout(binding=1, offset=448) uniform atomic_uint at2;		//Light Pixels no SM Expandido
layout(binding=1, offset=452) uniform atomic_uint at3;		//Shadow Pixels no SM Expandido  
layout(binding=1, offset=456) uniform atomic_uint at4;		//Light Pixels ambos os SM 
layout(binding=1, offset=460) uniform atomic_uint at5;		//Shadow Pixels ambos os SM
layout(binding=1, offset=464) uniform atomic_uint at6;		//Doubt Pixels (Light no Encolhido e Shadow no Expandido)
layout(binding=1, offset=468) uniform atomic_uint at7;		//Doubt Pixels (Shadow no Encolhido e Light no Expandido)  
layout(binding=1, offset=472) uniform atomic_uint at8;		//Non Light Facing

layout(binding=1, offset=476) uniform atomic_uint at22;		//Doubt Pixels(Total)(Apontador)
