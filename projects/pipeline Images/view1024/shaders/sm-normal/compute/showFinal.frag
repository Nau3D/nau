...
layout(binding=1, offset=656) uniform atomic_uint atPVPL;		
layout(binding=1, offset=660) uniform atomic_uint atPVCL;		   	
layout(binding=1, offset=664) uniform atomic_uint atLight;		
layout(binding=1, offset=668) uniform atomic_uint atShadow;
layout(binding=1, offset=672) uniform atomic_uint atDoubtLight;		
layout(binding=1, offset=676) uniform atomic_uint atDoubtShadow;
layout(binding=1, offset=680) uniform atomic_uint atCorrectL;		
layout(binding=1, offset=684) uniform atomic_uint atIncorrectL;   	
layout(binding=1, offset=688) uniform atomic_uint atCorrectS;   	
layout(binding=1, offset=692) uniform atomic_uint atIncorrectS;   	
layout(binding=1, offset=696) uniform atomic_uint atTotal;  	 	
...
uniform sampler2D texUnit; //Resultado dos ShadowMaps
