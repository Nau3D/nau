...
{
  //Check the property
  if((fileProperties & GLIFP_NORMAL) && 
     (fileProperties != GLIFP_NORMAL))
  {
  ...
  //Check the flag data
  if((fileProperties | (GLIFP_NORMAL | GLIFP_READONLY)) != (GLIFP_NORMAL | GLIFP_READONLY))
  {
  ...
  if(fileProperties & GLIFP_READONLY)
  {
