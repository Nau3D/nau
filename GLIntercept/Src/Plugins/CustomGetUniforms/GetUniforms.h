#ifndef __CUSTOM_GET_UNIFORMS_H_
#define __CUSTOM_GET_UNIFORMS_H_
...
//@
//  Summary:
//    Class that will store and read the uniforms from the program
//  
class GetUniforms : public InterceptPluginInterface
{
public:
  GetUniforms(InterceptPluginCallbacks *callBacks);
...
protected:
  ...
  //Program , Location, Uniform Data
  map<int, map<int, UniformData *>> uniforms;
