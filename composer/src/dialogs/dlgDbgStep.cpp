...
BEGIN_EVENT_TABLE(DlgDbgStep, wxDialog)
	EVT_BUTTON(DLG_BTN_NEXTPASS, DlgDbgStep::OnNextPass)
	EVT_BUTTON(DLG_BTN_NEXTFRAME, DlgDbgStep::OnNextFrame)
	EVT_BUTTON(DLG_BTN_TOPASS, DlgDbgStep::OnToPass)
END_EVENT_TABLE()
						   ...
						   wxDefaultSize,wxRESIZE_BORDER|wxDEFAULT_DIALOG_STYLE)
{
	...
	m_list = new wxListBox(this, 0, wxDefaultPosition, wxDefaultSize, 0, NULL, wxLB_SINGLE | wxLB_HSCROLL | wxEXPAND);
