...
BEGIN_EVENT_TABLE(DlgLog, wxDialog)
	EVT_BUTTON(DLG_BTN_CLEARLOG, DlgLog::OnClearLog)
	EVT_BUTTON(DLG_BTN_PROFILERLOG, DlgLog::OnProfilerLog)
	EVT_BUTTON(DLG_BTN_SAVELOG, DlgLog::OnSaveLog)
...
DlgLog::DlgLog(): wxDialog(DlgLog::m_Parent, -1, wxT("Nau - LOG"),wxDefaultPosition,
	...
	m_Log = new wxListBox(this,0,wxDefaultPosition,wxDefaultSize,0,NULL,wxLB_SINGLE | wxLB_HSCROLL | wxEXPAND);
	...
	bSizer1->Add(bSizer2, 0, wxALIGN_CENTER|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL|wxSHAPED, 5);
