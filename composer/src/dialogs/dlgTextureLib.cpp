...
DlgTextureLib::setupTexturesPanel(wxSizer *siz, wxWindow *parent) {
	...
	PropertyManager::createOrderedGrid(m_PGTextureProps, ITexture::GetAttribs(), order);
	PropertyManager::setAllReadOnly(m_PGTextureProps, ITexture::GetAttribs());
	m_PGTextureProps->SetSplitterLeft(true, true);

	siz->Add(m_GridTextures,0,wxALL|wxGROW|wxHORIZONTAL,5);

	wxBoxSizer *sizH2 = new wxBoxSizer(wxHORIZONTAL);
	sizH2->Add(m_PGTextureProps,1, wxGROW | wxALL  ,5);
	...
	sizH-> Add(m_BAddTex,0,wxALL |wxGROW |wxHORIZONTAL,5);
	sizH-> Add(m_BSaveRaw,0,wxALL |wxGROW |wxHORIZONTAL,5);
	sizH-> Add(m_BSavePNG,0,wxALL |wxGROW |wxHORIZONTAL,5);
	sizH-> Add(m_BSaveHDR,0,wxALL |wxGROW |wxHORIZONTAL,5);
	sizH-> Add(m_BUpdateIcons,0,wxALL |wxGROW |wxHORIZONTAL,5);
...
void DlgTextureLib::setTextureProps(int index) {
	...
	PropertyManager::updateGrid(m_PGTextureProps, ITexture::GetAttribs(), (AttributeValues *)texture);
