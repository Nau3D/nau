...
DlgMatBufferPanels::setPanel(wxSizer *siz, wxWindow *parent) {
	...
	sizerL->Add(sizH1,1,wxALL|wxALIGN_CENTER,5);
	...
	PropertyManager::createGrid(m_PG, nau::material::IMaterialBuffer::GetAttribs());

	std::vector<std::string> order = {"ID", "SIZE", "CLEAR"};
	PropertyManager::createOrderedGrid(m_PG, nau::material::IBuffer::GetAttribs(), order);

	PropertyManager::setAllReadOnly(m_PG, nau::material::IBuffer::GetAttribs());
	PropertyManager::setAllReadOnly(m_PG, nau::material::IMaterialBuffer::GetAttribs());
...
DlgMatBufferPanels::resetPropGrid() {
	...
	PropertyManager::createOrderedGrid(m_PG, nau::material::IMaterialBuffer::GetAttribs(), order2);
...
DlgMatBufferPanels::onProcessPanelChange(wxPropertyGridEvent& e) {
	...
	PropertyManager::updateProp(m_PG, name.ToStdString(), nau::material::IMaterialBuffer::GetAttribs(), (AttributeValues *)buffer);
	PropertyManager::updateProp(m_PG, name.ToStdString(), nau::material::IBuffer::GetAttribs(), (AttributeValues *)buffer->getBuffer());
}
...
DlgMatBufferPanels::updatePanel() {
	...
	PropertyManager::updateGrid(m_PG, nau::material::IMaterialBuffer::GetAttribs(), (AttributeValues *)buffer);
	PropertyManager::updateGrid(m_PG, nau::material::IBuffer::GetAttribs(), (AttributeValues *)buffer->getBuffer());
	m_PG->Refresh();
}
