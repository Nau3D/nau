...
DlgRenderTargets::setupGrid() {
	...
	PropertyManager::createGrid(m_PG, IRenderTarget::GetAttribs());
...
DlgRenderTargets::update() {
	...
	PropertyManager::updateGrid(m_PG, IRenderTarget::GetAttribs(), (AttributeValues *)elem);
...
void DlgRenderTargets::OnPropsChange( wxPropertyGridEvent& e) {
	...
	PropertyManager::updateProp(m_PG, topProp, IRenderTarget::GetAttribs(), (AttributeValues *)elem);
