...
DlgMatImageTexturePanels::setPanel(wxSizer *siz, wxWindow *parent) {
	...
	PropertyManager::createOrderedGrid(pg, nau::material::IImageTexture::GetAttribs(), order);
	PropertyManager::setAllReadOnly(pg, nau::material::IImageTexture::GetAttribs());
...
DlgMatImageTexturePanels::onProcessPanelChange(wxPropertyGridEvent& e) {
	...
	PropertyManager::updateProp(pg, name.ToStdString(), nau::material::IImageTexture::GetAttribs(), (AttributeValues *)it);
}
...
DlgMatImageTexturePanels::updatePanel() {
	...
	PropertyManager::updateGrid(pg, nau::material::IImageTexture::GetAttribs(), (AttributeValues *)it);
