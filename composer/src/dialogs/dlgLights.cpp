...
DlgLights::setupGrid() {
	...
	PropertyManager::createOrderedGrid(m_PG, Light::GetAttribs(), order);
...
//	unsigned int type = light->getPrope(Light::TYPE);
	...
	PropertyManager::updateGrid(m_PG, Light::GetAttribs(), (AttributeValues *)light);
...
void DlgLights::OnPropsChange( wxPropertyGridEvent& e) {
	...
	PropertyManager::updateProp(m_PG, topProp, Light::GetAttribs(), (AttributeValues *)light);
