...
DlgScenes::setupGrid() {
	...
	PropertyManager::createOrderedGrid(m_PG, IScene::GetAttribs(), s);
...
void DlgScenes::update() 
{
	...
	PropertyManager::updateGrid(m_PG, IScene::GetAttribs(), (AttributeValues *)scene.get());
	//wxString s;
...
void DlgScenes::OnPropsChange( wxPropertyGridEvent& e) {
	...
	PropertyManager::updateProp(m_PG, topProp, IScene::GetAttribs(), (AttributeValues *)scene.get());
