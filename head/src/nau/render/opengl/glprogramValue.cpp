...
GLUniform::Init() {
	...
	//spGLSLTypeSize[GL_IMAGE_1D] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_2D] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_3D] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_2D_RECT] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_CUBE] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_BUFFER] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_1D_ARRAY] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_2D_ARRAY] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_2D_MULTISAMPLE] = sizeof(int);
	//spGLSLTypeSize[GL_IMAGE_2D_MULTISAMPLE_ARRAY] = sizeof(int);

	//spGLSLTypeSize[GL_INT_IMAGE_1D] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_2D] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_3D] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_2D_RECT] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_CUBE] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_BUFFER] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_1D_ARRAY] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_2D_ARRAY] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_2D_MULTISAMPLE] = sizeof(int);
	//spGLSLTypeSize[GL_INT_IMAGE_2D_MULTISAMPLE_ARRAY] = sizeof(int);

	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_1D] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_2D] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_3D] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_2D_RECT] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_CUBE] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_BUFFER] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_1D_ARRAY] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_2D_ARRAY] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE] = sizeof(int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_IMAGE_2D_MULTISAMPLE_ARRAY] = sizeof(int);
	...
	//spGLSLTypeSize[GL_UNSIGNED_INT] = sizeof(unsigned int);
	//spGLSLTypeSize[GL_UNSIGNED_INT_VEC2] = sizeof(unsigned int) * 2;
	//spGLSLTypeSize[GL_UNSIGNED_INT_VEC3] = sizeof(unsigned int) * 3;
	//spGLSLTypeSize[GL_UNSIGNED_INT_VEC4] = sizeof(unsigned int) * 4;
