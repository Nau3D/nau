...
//int 
//ITextureSampler::getPrope(EnumProperty prop) {
//
...
//
//int 
//ITextureSampler::getPropi(IntProperty prop) {
//
...
//
//const vec4& 
//ITextureSampler::getPropf4(Float4Property prop) {
//
...
//
//void *
//ITextureSampler::getProp(int prop, Enums::DataType type) {
//
//	switch (type) {
//
//		case Enums::FLOAT:
...
//
//void 
//ITextureSampler::setProp(int prop, Enums::DataType type, void *value) {
//
//	switch (type) {
//
//		case Enums::FLOAT:
